...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark scroll-smooth">
      <body className={`${inter.variable} ${spaceGrotesk.variable} ${jetbrainsMono.variable} font-sans antialiased text-foreground selection:bg-primary/20 bg-background min-h-screen relative overflow-x-hidden`}>
        <AppProvider>
